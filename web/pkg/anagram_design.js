...
export function solve_words(words, allow_repeat, prioritize_soft_no, limit) {
    try {
        ...
        wasm.solve_words(retptr, addHeapObject(words), allow_repeat, prioritize_soft_no, limit);
 ...
 * @returns {any}
 */
export function zodiac_words() {
    const ret = wasm.zodiac_words();
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('anagram_design_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
